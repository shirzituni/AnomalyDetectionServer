...
int main(){
	...
	int x = rand() % 1000; // 0 -> 999 for example 100
	outputFile1 += to_string(x); // output_menu100
	outputFile1 += ".txt"; // output_menu100.txt
	outputFile2 += to_string(x); // output100
	outputFile2 += ".txt"; // output100.txt
